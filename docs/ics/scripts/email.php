...
if(isset($_POST['submit'])){
    $to = "periyasamy.kp@integralconcretes.com, ktagore@integralconcretes.com, asai@integralconcretes.com,operations@integralconcretes.com"; // this is your Email address
